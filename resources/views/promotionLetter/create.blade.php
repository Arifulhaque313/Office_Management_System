...
<div class="container">
    <div class="row justify-content-center">
        ...
        <div class="col-md-8">
            ...
            @endif
            <div class="card">
                <div class="card-header">Create Promotion Letter</div>
                <div class="card-body">
                    <form action="{{ route('promotion-letter.store') }}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-group w-60 mx-auto mb-3 d-lg-flex">
                            ...
                            <div class="expire-con w-100">
                                ...
                                <input type="date" name="effective_date" id="effective_date" class="form-control @error('date') is-invalid @enderror" value="{{ old('effective_date') }}">
                        ...
                        <div class="form-group w-60 mx-auto mb-3">
                            ...
                            <select name="from_designation" id="from_designation" class="form-control @error('from_designation') is-invalid @enderror">
                        ...
                        <div class="form-group w-60 mx-auto mb-3">
                            ...
                            <select name="to_designation" id="to_designation" class="form-control @error('to_designation') is-invalid @enderror">
                                <option value="">Select one</option>
                                @foreach($designations as $designation)
                                    <option value="{{ $designation->id }}">{{ $designation->designation_name }}</option>
                                @endforeach
                            </select>
                            @error('to_designation')
                                    <div class="text-danger">{{ $message }}</div>
                            @enderror
                        </div>
